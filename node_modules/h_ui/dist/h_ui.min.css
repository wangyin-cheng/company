...
.verify-tip {
  ...
  .verify-tip.verify-top {
    top: -31px; }
  .verify-tip.verify-top > .verify-tip-arrow {
...
.h-form-item-content > .h-select, .h-form-item-content > .h-selectTable, .h-form-item-content > .h-input-wrapper, .h-form-item-content > .h-date-picker,
.h-form-item-content > .h-fast-date, .h-form-item-content > .h-input-number, .h-form-item-content > .h-selectTree, .h-form-item-content > .h-typefield {
  vertical-align: top; }
...
.h-editgird {
  ...
  .h-editgird-cell {
    ...
    .h-editgird-cell-with-render {
      ...
      .h-editgird-cell-with-render div {
        float: left; }
    .h-editgird-cell-ellipsis-with-render {
      overflow: hidden;
      word-break: keep-all;
      white-space: nowrap;
      text-overflow: ellipsis; }
  ...
  .h-editgird-stripe .h-editgird-body tr td.h-editgird-stripe-light {
    background-color: #fff; }
  .h-editgird-stripe .h-editgird-body tr td.h-editgird-stripe-dark {
    background-color: #f0f3f5; }
  ...
  .h-editgird-wrapper .h-editgird-stripe .h-editgird-body tr.h-editgird-row-highlight td,
  .h-editgird-wrapper .h-editgird-stripe .h-editgird-fixed-body tr.h-editgird-row-highlight td,
  .h-editgird-wrapper .h-editgird-stripe .h-editgird-body tr.h-editgird-row-checked td,
  ...
  .h-editgird-sort {
    ...
    .h-editgird-sort i {
      ...
      transition: color 0.2s ease-in-out;
      font-size: 14px; }
      .h-editgird-sort i:hover {
        color: inherit; }
      .h-editgird-sort i.on {
        color: #298DFF; }
      .h-editgird-sort i:first-child {
        top: 0; }
      .h-editgird-sort i:last-child {
        bottom: 0; }
...
.h-btn {
  ...
  .h-btn-transparent {
    ...
    .h-btn-transparent > a:only-child {
      color: currentColor; }
      .h-btn-transparent > a:only-child:after {
        content: '';
        position: absolute;
        top: 0;
        left: 0;
        ...
        right: 0;
        background: transparent; }
    .h-btn-transparent:hover {
      color: #282c35;
      background-color: rgba(0, 0, 0, 0);
      border-color: rgba(0, 0, 0, 0); }
      .h-btn-transparent:hover > a:only-child {
        color: currentColor; }
        .h-btn-transparent:hover > a:only-child:after {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
          ...
          right: 0;
          background: transparent; }
    .h-btn-transparent:active, .h-btn-transparent.active {
      color: #3e4452;
      background-color: rgba(0, 0, 0, 0);
      border-color: rgba(0, 0, 0, 0); }
      .h-btn-transparent:active > a:only-child, .h-btn-transparent.active > a:only-child {
        color: currentColor; }
        .h-btn-transparent:active > a:only-child:after, .h-btn-transparent.active > a:only-child:after {
          content: '';
          position: absolute;
          top: 0;
          left: 0;
    ...
    fieldset[disabled] .h-btn-transparent:hover,
    fieldset[disabled] .h-btn-transparent:focus,
    ...
    fieldset[disabled] .h-btn-transparent.active {
      ...
      fieldset[disabled] .h-btn-transparent > a:only-child,
      fieldset[disabled] .h-btn-transparent:hover > a:only-child,
      fieldset[disabled] .h-btn-transparent:focus > a:only-child,
      fieldset[disabled] .h-btn-transparent:active > a:only-child,
      fieldset[disabled] .h-btn-transparent.active > a:only-child {
        color: currentColor; }
        ...
        fieldset[disabled] .h-btn-transparent > a:only-child:after,
        fieldset[disabled] .h-btn-transparent:hover > a:only-child:after,
        fieldset[disabled] .h-btn-transparent:focus > a:only-child:after,
        fieldset[disabled] .h-btn-transparent:active > a:only-child:after,
        fieldset[disabled] .h-btn-transparent.active > a:only-child:after {
          content: '';
          position: absolute;
          top: 0;
...
.h-form-item-changed .h-checkbox-checked:hover .h-checkbox-inner {
  border-color: #d9534f; }

.h-form-item-changed .h-checkbox-checked .h-checkbox-inner {
  border-color: #d9534f;
...
.h-checkbox-group-vertical {
  display: inline-block;
  vertical-align: middle; }
  .h-checkbox-group-vertical .h-checkbox-wrapper {
    display: block;
    height: 30px;
    line-height: 30px; }
...
.h-form-item-changed .h-radio-checked .h-radio-inner {
  border-color: #d9534f; }
  .h-form-item-changed .h-radio-checked .h-radio-inner:after {
    background: #d9534f; }

.h-form-item-changed .h-radio-checked:hover .h-radio-inner {
  border-color: #d9534f; }
...
.h-form-item-error .h-transfer .h-input {
  ...
  fieldset[readonly] .h-form-item-error .h-transfer .h-input {
    ...
    opacity: 0.8;
    color: #999; }
    .h-form-item-error .h-transfer .h-input-readonly:hover,
...
.h-editgird-cell-error .h-transfer .h-input {
  ...
  fieldset[readonly] .h-editgird-cell-error .h-transfer .h-input {
    ...
    opacity: 0.8;
    color: #999; }
    .h-editgird-cell-error .h-transfer .h-input-readonly:hover,
...
.h-typefield {
  ...
  .h-typefield-readonly input[readonly] {
    ...
    opacity: 0.8;
    color: #999; }
    .h-typefield-readonly input[readonly]:hover {
      border-color: #54a4ff; }
  .h-typefield-tip {
    position: absolute;
    display: block;
...
.h-select {
  ...
  .h-select-visible .h-select-selection {
    ...
    outline: 0;
    box-shadow: 0 0 0 2px rgba(41, 141, 255, 0.2); }
  .h-select-visible .h-select-arrow.h-icon-unfold {
    transform: rotate(180deg); }
  ...
  .h-select-readonly .h-select-selection {
    ...
    opacity: 0.8;
    color: #999; }
    .h-select-readonly .h-select-selection:hover {
      border-color: #54a4ff; }
...
.h-select-hideMult .h-select-item {
  padding-right: 12px;
  overflow: hidden;
  text-overflow: ellipsis; }
...
.h-table {
  ...
  .h-table-row-filterable td {
    color: #da0a15; }
  .h-table tr.h-table-row-dragover td {
    background-color: #298DFF;
    color: #fff; }
  .h-table-summation {
  ...
  .h-table-fixed-right {
    ...
    left: auto;
    right: 0; }
    .h-table-fixed-right .h-table-cell {
      padding-left: 15px;
      padding-right: 15px; }
    .h-table-fixed-right .h-table-hidden .h-table-cell {
      padding-left: 15px;
      padding-right: 15px; }
  ...
  .h-table-sortnew {
    ...
    .h-table-sortnew i {
      ...
      transition: color 0.2s ease-in-out;
      font-size: 14px; }
      .h-table-sortnew i:hover {
        color: inherit; }
      .h-table-sortnew i.on {
        color: #298DFF; }
      .h-table-sortnew i:first-child {
        top: 0; }
      .h-table-sortnew i:last-child {
        bottom: 0; }
    .h-table-sortnew i {
      color: #c3cbd6;
      transition: color 0.2s ease-in-out; }
  ...
  .h-table-sortSimp {
    ...
    .h-table-sortSimp i {
      ...
      transition: color 0.2s ease-in-out;
      font-size: 14px; }
      .h-table-sortSimp i:hover {
        color: inherit; }
      .h-table-sortSimp i.on {
        color: #298DFF; }
      .h-table-sortSimp i:first-child {
        top: 0; }
      .h-table-sortSimp i:last-child {
        bottom: 0; }
  .h-table-newsort-wrap {
    display: inline-block;
    position: absolute;
    right: 0px;
    background: #ffff;
...
.h-page {
  ...
  .h-page-options {
    ...
    .h-page-options-sizer {
      display: inline-block;
      margin-right: 10px; }
      .h-page-options-sizer .h-select-single {
        height: 32px; }
        .h-page-options-sizer .h-select-single .h-select-selection {
          height: 32px; }
          .h-page-options-sizer .h-select-single .h-select-selection .h-select-placeholder {
            height: 30px;
            line-height: 30px; }
          .h-page-options-sizer .h-select-single .h-select-selection .h-select-selected-value {
            height: 30px;
            line-height: 30px; }
    ...
    .h-page-options-elevator {
      ...
      .h-page-options-elevator input {
        ...
        fieldset[readonly] .h-page-options-elevator input {
          ...
          opacity: 0.8;
          color: #999; }
          .h-page-options-elevator input-readonly:hover,
        ...
        .h-page-options-elevator input-small {
          ...
          height: 24px;
          border-radius: 3px; }
    .h-page-options-reload {
      display: inline-block;
      vertical-align: middle;
      margin-left: 10px; }
      .h-page-options-reload a {
        display: inline-block;
        vertical-align: middle;
        min-width: 32px;
        height: 32px;
...
.h-page.mini .h-page-options {
  ...
  .h-page.mini .h-page-options-elevator {
    ...
    .h-page.mini .h-page-options-elevator input {
      ...
      border-radius: 3px;
      width: 44px; }
  .h-page.mini .h-page-options-reload {
    margin-left: 6px; }
    .h-page.mini .h-page-options-reload a {
      border: 0;
...
.h-date-picker {
  ...
  .h-date-picker .h-select-dropdown {
    ...
    overflow: visible;
    max-height: none; }
  .h-date-picker-cells:not(.h-date-picker-cells-month-selection) span {
    width: 24px;
    height: 24px; }
  .h-date-picker-cells:not(.h-date-picker-cells-month-selection) span.h-date-picker-cells-cell {
    width: 28px;
    height: 28px; }
  .h-date-picker-cells {
    width: 196px;
  ...
  .h-date-picker-cells-show-week-numbers {
    width: 226px; }
  .h-date-picker-cells-year span, .h-date-picker-cells-month:not(.h-date-picker-cells-month-selection) span {
    width: 40px;
    height: 28px;
    margin: 10px 12px; }
  .h-date-picker-cells-month-selection span {
    padding: 10px 12px; }
  ...
  .h-date-picker-transfer {
    ...
    max-height: none;
    width: auto; }
    .h-date-picker-transfer span.h-date-picker-cells-cell-disabled,
    .h-date-picker-transfer span.h-date-picker-cells-cell-disabled:hover {
      cursor: not-allowed;
      background: #f7f7f7;
      color: #c3cbd6; }
      .h-date-picker-transfer span.h-date-picker-cells-cell-disabled em,
      .h-date-picker-transfer span.h-date-picker-cells-cell-disabled:hover em {
        color: inherit;
        background: inherit; }
...
.h-cascader {
  line-height: normal; }
  .h-cascader.h-cascader-multiple .h-cascader-rel {
    line-height: 32px;
    height: 32px;
    background: #fff;
    border: 1px solid #D7DDE4;
    ...
    cursor: pointer;
    overflow: hidden; }
    .h-cascader.h-cascader-multiple .h-cascader-rel:hover {
      border-color: #54a4ff; }
    .h-cascader.h-cascader-multiple .h-cascader-rel .h-cascader-tag-wrapper {
      width: 100%;
      padding-right: 25px;
      overflow-y: auto;
      height: 100%; }
      .h-cascader.h-cascader-multiple .h-cascader-rel .h-cascader-tag-wrapper .h-tag {
        cursor: inherit;
        position: relative;
        white-space: nowrap;
        max-width: 40%;
        ...
        background: #F5F5F5 !important;
        border: 1px solid #F7F7F7 !important; }
        .h-cascader.h-cascader-multiple .h-cascader-rel .h-cascader-tag-wrapper .h-tag > .h-icon {
          position: absolute;
          right: 0; }
        .h-cascader.h-cascader-multiple .h-cascader-rel .h-cascader-tag-wrapper .h-tag span {
          display: inline-block;
          width: 100%; }
    .h-cascader.h-cascader-multiple .h-cascader-rel i.offset-left {
      right: 20px; }
  .h-cascader.h-cascader-multiple.h-cascader-disabled .h-cascader-rel {
    background-color: #f7f7f7; }
    .h-cascader.h-cascader-multiple.h-cascader-disabled .h-cascader-rel:hover {
      border-color: #D7DDE4; }
    .h-cascader.h-cascader-multiple.h-cascader-disabled .h-cascader-rel .h-tag {
      color: #999; }
  .h-cascader.h-cascader-multiple.h-cascader-visible .h-cascader-rel {
    border-color: #54a4ff;
    box-shadow: 0 0 0 2px rgba(41, 141, 255, 0.2); }
  .h-cascader.h-cascader-multiple.h-cascader-size-small .h-cascader-rel {
    line-height: 26px;
    height: 26px; }
  .h-cascader.h-cascader-multiple.h-cascader-size-large .h-cascader-rel {
    line-height: 36px;
    height: 36px; }
  .h-cascader-rel {
    display: inline-block;
  ...
  .h-cascader .h-input {
    display: block;
    cursor: pointer; }
  .h-cascader-disabled .h-input, .h-cascader-disabled .h-cascader-tag-wrapper {
    cursor: not-allowed; }
  .h-cascader-label {
    width: 100%;
    height: 100%;
...
.h-selectTree {
  ...
  .h-selectTree-readonly .h-selectTree-selection {
    ...
    opacity: 0.8;
    color: #999; }
    .h-selectTree-readonly .h-selectTree-selection:hover {
      border-color: #54a4ff; }
...
.h-selectTable {
  ...
  .h-selectTable-selection {
    ...
    border: 1px solid #D7DDE4;
    transition: all 0.2s ease-in-out; }
    .h-selectTable-selection .h-selectTable-arrow.h-icon-close {
      display: none;
      cursor: pointer; }
    .h-selectTable-selection:hover {
      ...
      .h-selectTable-selection:hover .h-selectTable-arrow:nth-of-type(1) {
        display: inline-block; }
      .h-selectTable-selection:hover .h-selectTable-arrow:nth-of-type(2) {
        display: none; }
  ...
  .h-selectTable-visible .h-selectTable-selection {
    ...
    outline: 0;
    box-shadow: 0 0 0 2px rgba(41, 141, 255, 0.2); }
  .h-selectTable-visible .h-selectTable-arrow.icon-unfold {
    transform: rotate(180deg); }
  .h-selectTable-disabled .h-selectTable-selection .h-selectTable-arrow:nth-of-type(2), .h-selectTable-readonly .h-selectTable-selection .h-selectTable-arrow:nth-of-type(2) {
    display: none; }
  .h-selectTable-disabled .h-selectTable-selection .h-selectTable-input, .h-selectTable-readonly .h-selectTable-selection .h-selectTable-input {
    cursor: not-allowed; }
  ...
  .h-selectTable-readonly .h-selectTable-selection {
    ...
    opacity: 0.8;
    color: #999; }
    .h-selectTable-readonly .h-selectTable-selection:hover {
      border-color: #54a4ff; }
  ...
  .h-selectTable-right {
    text-align: right; }
  .h-selectTable-hideMultHead {
    position: relative;
    display: block;
    font-size: 12px;
    padding: 7px 12px; }
  .h-selectTable-hideMultHead:hover {
    cursor: pointer; }
  .h-selectTable-hideMultHead:after {
    display: inline-block;
    font-family: "iconfont" !important;
    speak: none;
    font-style: normal;
    ...
    top: 8px;
    right: 20px; }
  .h-selectTable-hideMultHead-select, .h-selectTable-hideMultHead-select:after {
    color: #5ca8ff; }
  .h-selectTable-selected-num {
    display: block;
    height: 30px;
    line-height: 30px;
    padding-left: 8px;
    font-size: 12px; }
  .h-selectTable-btnToTop {
    padding: 7px 14px; }
    .h-selectTable-btnToTop-invert {
      float: right;
      margin-right: 12px; }
...
.h-form-item-changed .h-selectTable-input {
  color: #d9534f; }
...
.h-selectTable-header-slot {
  border-bottom: 1px solid #e1e1e1; }

.h-selectTable-header-slot-top {
  border-bottom: 1px solid #e1e1e1;
  margin-top: 52px; }
...
.h-editgird-stripe .h-editgird-body tr.h-editgird-stripe-dark td {
  background-color: #f0f3f5; }

.h-editgird-stripe .h-editgird-body tr.h-editgird-stripe-light td {
  background-color: #fff; }
...
.h-typefield-range {
  ...
  .h-typefield-range-readonly input[readonly] {
    ...
    opacity: 0.8;
    color: #999; }
    .h-typefield-range-readonly input[readonly]:hover {
      border-color: #54a4ff; }
...
.h-select-block-item-header {
  ...
  background: #f7f7f7;
  z-index: 1; }
  .h-select-block-item-header .item-header {
    display: inline-block;
    overflow: hidden;
    text-overflow: ellipsis;
    background: #f7f7f7; }
...
.h-select-block-item {
  ...
  white-space: nowrap;
  font-size: 0; }
  .h-select-block-item div, .h-select-block-item p, .h-select-block-item i, .h-select-block-item b {
    font-size: 12px; }
  .h-select-block-item > span {
    font-size: 12px; }
  .h-select-block-item .itemcol {
    display: inline-block;
    overflow: hidden;
    text-overflow: ellipsis; }
  .h-select-block-item > span:last-child {
    padding-right: 14px; }
...
.h-select-block-loading-placeholder {
  visibility: hidden;
  height: 30px; }

.h-select-block-hideMult .h-select-block-item {
  overflow: hidden;
  text-overflow: ellipsis; }
  .h-select-block-hideMult .h-select-block-item > span {
    display: inline-block;
    overflow: hidden;
    text-overflow: ellipsis; }
  .h-select-block-hideMult .h-select-block-item:after {
    display: inline-block;
    font-family: "iconfont" !important;
    speak: none;
    font-style: normal;
    ...
    top: 5px;
    right: 2px; }
  .h-select-block-hideMult .h-select-block-item:hover:after {
    color: #e5ebf1; }

.h-select-block-hideMult .h-select-block-selected:after {
  color: #5ca8ff !important; }

.h-select-block-disabled {
  color: #c3cbd6;
  cursor: not-allowed; }
  .h-select-block-disabled:hover {
    background: transparent;
    cursor: not-allowed; }
...
.h-calendar-top-icon:hover {
  background-color: #f7f7f7; }

.h-calendar-top-icon.h-prev-year {
  margin-right: 30px; }

.h-calendar-top-icon.h-next-year {
  margin-left: 30px; }
...
.h-calendar-month-content-item {
  ...
  .h-calendar-month-content-item .h-badge {
    width: 0;
    height: 0; }
    .h-calendar-month-content-item .h-badge .h-badge-count {
      top: -25px;
      right: -20px; }
...
.h-schedule {
  ...
  .h-schedule-header {
    position: relative;
    text-align: center; }
    .h-schedule-header .h-btn-group, .h-schedule-header .h-schedule-today-btn {
      position: absolute;
      top: 1px; }
    .h-schedule-header .h-schedule-today-btn {
      margin-left: 10px;
      right: 1.5%;
      height: 34px; }
    .h-schedule-header .h-btn-group {
      left: 1.5%; }
    .h-schedule-header .h-btn-group button {
      width: 35px;
      padding-left: 10px;
      padding-right: 10px;
      height: 34px; }
    .h-schedule-header .h-schedule-date-text {
      display: inline-block; }
  .h-schedule-events {
    position: absolute;
    top: 136px;
    ...
    flex-wrap: wrap;
    /* 展示更多活动的窗口 */ }
    .h-schedule-events .h-schedule-event-wrapper {
      width: 14.28%;
      height: 75px;
      margin-top: 25px; }
      .h-schedule-events .h-schedule-event-wrapper:nth-child(7n + 1) {
        padding-left: 1px; }
      .h-schedule-events .h-schedule-event-wrapper:nth-child(7n) {
        padding-right: 2px; }
      .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-content {
        pointer-events: auto;
        height: 16px;
        margin-bottom: 2px;
        padding-left: 5px;
        ...
        white-space: nowrap;
        cursor: pointer; }
        .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-content.h-schedule-event-placeholder {
          opacity: 0;
          pointer-events: none; }
        .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-content.event-place-start {
          margin-left: 5px;
          border-radius: 0 3px 3px 0; }
        .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-content.event-place-end {
          margin-right: 5px;
          border-radius: 0 3px 3px 0; }
        .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-content.event-place-start.event-place-end {
          border-radius: 3px; }
      .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-more {
        text-align: center; }
        .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-more i {
          display: inline-block;
          pointer-events: auto;
          width: 18px;
          ...
          cursor: pointer; }
          .h-schedule-events .h-schedule-event-wrapper .h-schedule-event-more i:hover {
            color: #000; }
    .h-schedule-events .h-schedule-popover {
      position: absolute;
      z-index: 10;
      width: 14.28%;
      min-width: 220px;
      ...
      color: #444;
      pointer-events: auto; }
      .h-schedule-events .h-schedule-popover-header {
        line-height: 1.5;
        padding: 0 4px;
        background: #ddd;
        font-size: 12px; }
        .h-schedule-events .h-schedule-popover-header i.icon-close {
          display: inline-block;
          float: right;
          cursor: pointer; }
      .h-schedule-events .h-schedule-popover-body {
        padding: 10px 10px 0;
        max-height: 150px;
        overflow: auto; }
        .h-schedule-events .h-schedule-popover-body-item {
          background: #2e97d0;
          color: #fff;
          margin-bottom: 2px;
          border-radius: 3px;
          ...
          overflow: hidden;
          cursor: pointer; }
          .h-schedule-events .h-schedule-popover-body-item:last-child {
            margin-bottom: 10px; }
  .h-schedule .h-calendar-today::before {
    content: "\25CF";
    position: absolute;
    top: 5px;
    left: 6%;
    ...
    line-height: 1;
    font-size: 14px; }
  .h-schedule .h-calendar-month-content .h-calendar-month-content-item {
    cursor: default; }
    .h-schedule .h-calendar-month-content .h-calendar-month-content-item .h-calendar-month-content-item-text {
      position: absolute;
      line-height: 1;
      top: 4px;
      right: 4px; }
